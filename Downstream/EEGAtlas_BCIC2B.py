    ...
    for seed in [7,42,718]:
        ...
        for test_sub in all_subjects:
            ...
            checkpoint_callback = ModelCheckpoint(
                dirpath=f'./logs/EEGAtlas/Seed{seed}/Subject{test_sub} Model',
                filename=f'EEGAtlas_Sub{test_sub}',
                monitor='valid_loss',
                mode='min',
                save_top_k=1,
                every_n_epochs=1,
            ...
            logger = [
                pl_loggers.TensorBoardLogger(f'./logs/EEGAtlas/Seed{seed}/', name="LOSO_BCIC2b_tb", version=f"test_sub{test_sub}"),
                pl_loggers.CSVLogger(f'./logs/EEGAtlas/Seed{seed}/', name="LOSO_BCIC2b_csv", version=f"test_sub{test_sub}")
            ]
